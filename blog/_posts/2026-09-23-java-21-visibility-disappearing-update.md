...
For the fix, use atomic updates such as `AtomicInteger.incrementAndGet()` or compare-and-set loops. See the Atomic Operations post in this series for the full compare-and-set walk-through.
