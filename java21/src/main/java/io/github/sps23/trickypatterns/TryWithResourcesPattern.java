 ...
 * 
 * The tricky part: Resources are closed in reverse order, suppressed exceptions,
 * and the confusion between try-with-resources and traditional try-finally.
 */
public class TryWithResourcesPattern {
    ...
    private static void demonstrateCloseOrder() {
        ...
        try (
            DemoResource first = new DemoResource("First");
