 ...
 *
 * The tricky part: Should you pass an empty array or a sized array? Common on
 * StackOverflow: list.toArray(new String[0]) vs list.toArray(new
 * String[list.size()])
 */
public class ArrayToArrayPattern {
    ...
    /**
     * OLD PATTERN (Pre-Java 6): Passing sized array People still copy this from old
    ...
    /**
     * OPTIMAL PATTERN (Since Java 6+): Passing empty array This is actually FASTER
