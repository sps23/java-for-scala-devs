...
/**
 * Demonstrates the confusing Stream.of() vs Arrays.stream() behavior for primitives.
 * 
 * The tricky part: Stream.of(primitiveArray) treats the array as a single element,
 * while Arrays.stream(primitiveArray) creates a stream of the elements.
 */
